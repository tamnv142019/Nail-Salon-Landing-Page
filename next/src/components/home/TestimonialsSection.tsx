...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="py-20 md:py-32 bg-secondary dark:bg-background relative overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-br from-primary-soft/60 via-transparent to-transparent"></div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-card border border-border rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
              <div className="w-12 h-12 bg-accent text-accent-foreground rounded-full flex items-center justify-center shadow-xl">
