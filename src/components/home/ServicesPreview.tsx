        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 shadow-lg text-lg font-semibold bg-brand-gold-soft hover:bg-brand-gold-muted text-brand-dark dark:bg-brand-gold-soft dark:hover:bg-brand-gold dark:text-white"
            >
        ...
        {selectedService && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setSelectedService(null)}
                className="absolute top-4 right-4 z-10 w-10 h-10 bg-black/10 hover:bg-black/15 dark:bg-white/10 dark:hover:bg-white/15 rounded-full flex items-center justify-center transition-colors backdrop-blur-sm"
              >
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="flex-1 px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-lg font-semibold cursor-pointer bg-brand-gold-soft hover:bg-brand-gold-muted text-brand-dark dark:bg-brand-gold-soft dark:hover:bg-brand-gold dark:text-white"
                  >
