          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-card rounded-2xl shadow-2xl p-6 border border-border">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-brand-gold-soft text-brand-dark dark:bg-brand-gold dark:text-white flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center p-4 bg-card border border-border rounded-xl">
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-brand-gold-soft text-brand-dark dark:bg-brand-gold dark:text-white rounded-xl mb-3">
            ...
            <div className="space-y-3 mb-12">
              {[
                ...
                <div key={index} className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-brand-gold-soft text-brand-dark dark:bg-brand-gold dark:text-white flex items-center justify-center shrink-0">
