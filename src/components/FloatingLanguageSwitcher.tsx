    ...
    <>
      ...
      <div className="fixed top-6 right-6 z-50">
        ...
        <button
          ...
          className="flex items-center justify-center w-14 h-14 rounded-full bg-btn-accent hover:bg-btn-accent-hover active:bg-btn-accent-active text-btn-theme-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
      ...
      {/* Toast Notification */}
      {showNotification && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-6 py-3 rounded-full bg-btn-accent text-btn-theme-foreground shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-300">
          <Check size={20} />
