    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-1">
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-btn-accent/40 rounded-full animate-pulse will-change-transform"
            style={{
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <button
            ...
            className="inline-block px-10 py-4 rounded-full font-bold text-lg hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-3xl bg-btn-accent hover:bg-btn-accent-hover active:bg-btn-accent-active text-btn-theme-foreground"
          >
