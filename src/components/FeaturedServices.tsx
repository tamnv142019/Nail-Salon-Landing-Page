  ...
  return (
    <section id="services" className="py-32 px-6 bg-background transition-colors duration-500 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -right-1/4 w-96 h-96 bg-brand-gold-soft/15 dark:bg-brand-gold/6 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20 animate-in fade-in slide-in-from-bottom-5 duration-700">
          <span className="inline-block px-6 py-2 bg-brand-gold-soft/25 dark:bg-brand-gold/15 backdrop-blur-sm border border-border rounded-full text-brand-dark dark:text-white text-sm mb-6 transition-colors duration-500">
            ✨ Our Services
          </span>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button 
                      ...
                      className="px-6 py-2 rounded-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer bg-brand-gold-soft hover:bg-brand-gold-muted text-brand-dark dark:bg-brand-gold-soft dark:hover:bg-brand-gold dark:text-white">
                      Learn More
                    </button>
                  </div>
                </div>
