    ...
    <section className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-400">
          <button
            onClick={onBookClick}
            className="group relative px-10 py-5 rounded-full transition-all duration-300 shadow-2xl hover:shadow-white/50 hover:scale-110 flex items-center justify-center gap-3 overflow-hidden cursor-pointer bg-btn-accent hover:bg-btn-accent-hover active:bg-btn-accent-active text-btn-theme-foreground"
          >
