...
function ServiceBadge({ type }: { type: BadgeType }) {
  ...
  const styles = {
    ...
    'Best Seller': {
      gradient: 'from-[color:var(--badge-best-seller)] via-[color:var(--badge-best-seller)] to-[color:var(--badge-best-seller)]',
      Icon: Star,
    },
  } as const;
    ...
    <>
      <section id="services" className="py-32 px-6 bg-secondary dark:bg-background relative overflow-hidden transition-colors duration-500">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-btn-accent/35 dark:bg-brand-gold/10 rounded-full blur-3xl animate-pulse transition-colors duration-500"></div>
