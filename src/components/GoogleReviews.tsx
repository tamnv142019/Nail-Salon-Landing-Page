...
const FeaturedReviewCard = memo(({ review }: { review: typeof reviews[0] }) => {
  return (
    <div className="bg-linear-to-br from-white to-rose-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl border-2 border-rose-200 dark:border-rose-800 relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute top-0 right-0 w-24 md:w-32 h-24 md:h-32 bg-linear-to-br from-rose-300/20 to-transparent dark:from-rose-500/20 rounded-full blur-2xl"></div>
      
      {/* Badge */}
      <div className="absolute top-4 md:top-6 right-4 md:right-6">
        <div className="bg-linear-to-r from-yellow-400 to-orange-500 text-white px-3 md:px-4 py-1 md:py-1.5 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg">
          <Award size={12} />
  ...
  return (
    <section id="google-reviews" className="py-16 md:py-24 px-4 md:px-6 bg-linear-to-b from-gray-50 to-white dark:from-black dark:to-gray-900 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Other Reviews Grid */}
        <div className="mb-8 md:mb-12">
          <h3 className="text-xl md:text-2xl text-foreground mb-4 md:mb-6">What Our Clients Say</h3>
        ...
        <div className="text-center">
          <div className="inline-block bg-linear-to-br from-white to-blue-50 dark:from-gray-800 dark:to-blue-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-2xl max-w-2xl">
            <div className="inline-flex items-center justify-center w-12 h-12 md:w-16 md:h-16 bg-linear-to-br from-blue-500 to-blue-600 rounded-xl md:rounded-2xl mb-4 md:mb-6 shadow-lg">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 md:gap-3 px-6 md:px-8 py-3 md:py-4 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-full transition-all duration-300 hover:scale-105 shadow-lg text-sm md:text-lg font-semibold"
            >
