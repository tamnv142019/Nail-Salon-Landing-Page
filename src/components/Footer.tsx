    ...
    <footer className="bg-secondary dark:bg-background border-t border-border text-foreground py-16 px-6 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-5 duration-700">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl bg-linear-to-r from-foreground via-brand-gold-muted to-foreground bg-clip-text text-transparent">
                Queen's Nails Hair & Skincare
              </span>
            </div>
            <p className="text-muted-foreground mb-6 max-w-xs transition-colors duration-500">
              {t('footer.description', 'Experience luxury nail care with premium services and professional artistry.')}
            </p>
            <div className="flex gap-2">
              <span className="text-muted-foreground text-sm">📍 4869 Santa Monica Ave, San Diego</span>
            </div>
            <div className="flex gap-2 mt-2">
              <span className="text-muted-foreground text-sm">📞 (619) 224-5050</span>
            </div>
          </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-5 duration-700" style={{ animationDelay: '100ms' }}>
            ...
            <div className="space-y-2 text-muted-foreground transition-colors duration-500">
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-card border border-border text-muted-foreground flex items-center justify-center hover:bg-brand-sapphire hover:text-white hover:border-transparent transition-all duration-300 hover:scale-110"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-card border border-border text-muted-foreground flex items-center justify-center hover:bg-brand-ruby hover:text-white hover:border-transparent transition-all duration-300 hover:scale-110"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-card border border-border text-muted-foreground flex items-center justify-center hover:bg-brand-emerald hover:text-white hover:border-transparent transition-all duration-300 hover:scale-110"
          ...
          <div className="animate-in fade-in slide-in-from-bottom-5 duration-700" style={{ animationDelay: '200ms' }}>
            ...
            <ul className="space-y-3 text-muted-foreground transition-colors duration-500">
              {[
          ...
          <div className="animate-in fade-in slide-in-from-bottom-5 duration-700" style={{ animationDelay: '300ms' }}>
            ...
            <p className="text-muted-foreground mb-4 text-sm leading-relaxed transition-colors duration-500">
            ...
            {isSubscribed ? (
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                ...
                <button 
                  type="submit"
                  className="px-4 py-3 rounded-xl transition-all duration-300 hover:scale-105 group bg-brand-gold-soft hover:bg-brand-gold-muted text-brand-dark dark:bg-brand-gold-soft dark:hover:bg-brand-gold dark:text-white"
                >
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-600 transition-colors">
          ...
          <div className="flex gap-6 text-muted-foreground text-sm transition-colors duration-500">
            <button
